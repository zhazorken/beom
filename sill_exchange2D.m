% Test-case of a sill exchange over a ridge (2-D).
  ...
  npts = 200;                                   % Number of grid points in the sponge.
  grav = 9.8;                                  % m/s2
  rhon = [1027.47, 1027.75];  %1027.75                 % Density of layers (kg/m3).
...
n( 1 : round( 0.6 * (lm + 2) ),           :, 2 ) =0;
n(     round( 0.6 * (lm + 2) ) + 1 : end, :, 2 ) = ...
repmat(-h_bo( round( 0.6 * (lm + 2) ) + 1 : end, 2)+500+4.*hsal,1,3);
